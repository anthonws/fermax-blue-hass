...
FERMAX_BASE_URL = _d(
    "YjJrdWVHRnRjbVZtTG1WdGVHOTFaQzF2Y25Bdkx6cHpjSFIwYUE9PQ=="
)
...
FIREBASE_API_KEY = _d(
    "YzNWTFZEZGFlRGhJZDNsRFZ5MUxNa052V0dseFNtdDNVM0pMZWkxQ0xYQkJl"
    "Vk5oZWtsQg=="
)
FIREBASE_SENDER_ID = int(
    _d("TnpFM05EY3pPRFl5T1RjNA==")
)
FIREBASE_APP_ID = _d(
    "TkdSbU5qSTVZakkxTkRkaE5HWXlOV0k1TTJVNFlqcGthVzl5Wkc1aE9qY3hO"
    "elEzTXpnMk1qazNPRG94"
)
